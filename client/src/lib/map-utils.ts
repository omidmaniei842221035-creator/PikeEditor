...
export function getBusinessIcon(businessType: string): string {
  ...
  // Enhanced keyword matching for common Persian business categories
  const keywordMatches: Record<string, string> = {
    'سوپر': '🛒', 'مارکت': '🛒', 'فروشگاه': '🏪', 'بقالی': '🏪',
    'رستوران': '🍽️', 'غذا': '🍽️', 'کباب': '🥙', 'چلو': '🍛', 'پیتزا': '🍕', 'ساندویچ': '🥪', 'فست': '🍟',
    'کافه': '☕', 'قهوه': '☕', 'چای': '🍵',
    'نان': '🍞', 'شیرینی': '🧁', 'قنادی': '🎂',
    'میوه': '🍎', 'سبزی': '🥬', 'گوشت': '🥩', 'مرغ': '🐔', 'ماهی': '🐟', 'لبنیات': '🥛',
    'پوشاک': '👕', 'لباس': '👕', 'بوتیک': '👗', 'کیف': '👜', 'کفش': '👟', 'چرم': '🧥',
    'طلا': '💰', 'جواهر': '💎', 'نقره': '⚪', 'ساعت': '⌚',
    'آرایش': '💇', 'زیبایی': '💅', 'سالن': '💇',
    'دارو': '💊', 'عطاری': '🌿', 'پزشک': '🏥', 'دندان': '🦷', 'چشم': '👁️', 'کلینیک': '🏥',
    'عطر': '🌸', 'ادکلن': '🌸', 'بهداشت': '🧴',
    'موبایل': '📱', 'کامپیوتر': '💻', 'لپ‌تاپ': '💻', 'الکترون': '⚡', 'تلویزیون': '📺', 'دوربین': '📷',
    'خودرو': '🚗', 'ماشین': '🚗', 'تعمیر': '🔧', 'یدکی': '🔩', 'تایر': '🛞', 'کارواش': '🚿', 'بنزین': '⛽',
    'بانک': '🏦', 'صرافی': '💱', 'بیمه': '🛡️', 'حساب': '📊', 'مالی': '📊',
    'املاک': '🏡', 'مسکن': '🏠', 'ساختمان': '🏗️', 'معمار': '📐', 'پیمانکار': '👷',
    'هتل': '🏨', 'مسافر': '✈️', 'تور': '🎒', 'گردشگری': '🗺️',
    'ورزش': '🏋️', 'باشگاه': '🏋️', 'استخر': '🏊', 'فوتبال': '⚽',
    'کتاب': '📚', 'تحریر': '✏️', 'آموزش': '🎓', 'مدرسه': '🏫', 'زبان': '🌍',
    'چاپ': '🖨️', 'طراحی': '🎨', 'عکاس': '📸', 'فیلم': '🎬',
    'کشاورز': '🌾', 'باغ': '🌳', 'گل': '🌹', 'گیاه': '🌱',
    'کارخانه': '🏭', 'صنعت': '🏭', 'نساجی': '🧵', 'فلز': '🔨', 'نجار': '🪚', 'چوب': '🌲',
    'اسباب‌بازی': '🧸', 'هدیه': '🎁', 'سوغات': '🎁',
    'نظافت': '🧹', 'حمل': '🚚', 'بار': '📦', 'انبار': '🏪',
    'برق': '⚡', 'تاسیسات': '🔧', 'لوله': '💧', 'گاز': '🔥',
    'حقوق': '📋', 'وکیل': '📋', 'مشاور': '👨‍💼', 'خدمات': '🏪'
  };
