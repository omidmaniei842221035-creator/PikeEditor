...
export const businessIconsMap: Record<string, string> = {
  // سوپرمارکت و فروشگاه‌ها
  'سوپرمارکت': '🛒', 'سوپرمارکتها و فروشگاههای محصولات غذایی': '🛒', 'فروشگاه عمومی': '🏪', 
  'مینی‌مارکت': '🏪', 'فروشگاه زنجیره‌ای': '🏬', 'هایپرمارکت': '🛍️', 'بقالی': '🏪',
  'خواربار فروشی': '🛒', 'خواروبار': '🛒', 'مواد غذایی': '🛒',
  
  // رستوران و غذا
  'رستوران': '🍽️', 'رستوران و سایر خدمات خوراک': '🍽️', 'کافه': '☕', 'فست‌فود': '🍟', 
  'نانوایی': '🍞', 'قنادی': '🧁', 'شیرینی‌پزی': '🎂', 'کباب‌سرا': '🥙', 
  'چلوکباب': '🍛', 'سالن پذیرایی': '🏛️', 'کافه‌رستوران': '☕', 'بوفه': '🍴', 
  'کانتین': '🥪', 'آشپزخانه صنعتی': '👨‍🍳', 'آبمیوه‌فروشی': '🥤', 'بستنی‌فروشی': '🍦', 
  'قهوه‌خانه': '☕', 'چای‌خانه': '🍵', 'ساندویچی': '🥪', 'پیتزا فروشی': '🍕',
  'اغذیه فروشی': '🍔', 'غذای آماده': '🍱', 'کترینگ': '🍲', 'تهیه غذا': '🍛',
  
  // میوه و سبزیجات و مواد غذایی
  'مغازه میوه': '🍎', 'سبزی‌فروشی': '🥬', 'گوشت‌فروشی': '🥩', 'مرغ‌فروشی': '🐔', 
  'ماهی‌فروشی': '🐟', 'لبنیات': '🥛', 'عسل فروشی': '🍯', 'ادویه فروشی': '🌶️', 
  'خشکبار': '🥜', 'چای و قهوه': '🍵', 'نوشیدنی': '🥤', 'بستنی ساز': '🍧',
  'آجیل فروشی': '🥜', 'تره‌بار': '🥕', 'میوه و تره بار': '🍊',
  
  // پوشاک و منسوجات
  'پوشاک': '👕', 'بوتیک': '👗', 'پوشاک مردانه': '🤵', 'پوشاک زنانه': '👩‍🦱', 
  'پوشاک بچگانه': '👶', 'کیف و کفش': '👜', 'کفش‌فروشی': '👟', 'کیف فروشی': '👜', 
  'چرم فروشی': '🧥', 'پارچه فروشی': '🧵', 'خیاطی': '🧷', 'طراحی مد': '✂️',
  'لباس عروس': '👰', 'کراوات و پیراهن': '👔', 'لباس ورزشی': '👕', 'زیرپوش': '👙', 
  'جوراب': '🧦', 'کلاه': '👒', 'فروشگاه پوشاک و البسه': '👕', 'منسوجات': '🧵',
  'مزون': '👗', 'لباس فروشی': '👔', 'البسه': '👕',
  
  // طلا و جواهر
  'عینک آفتابی': '🕶️', 'ساعت': '⌚', 'جواهرات': '💎', 'طلا و جواهر': '💰', 
  'نقره فروشی': '⚪', 'سکه و طلا': '🪙', 'طلافروشی': '💍', 'جواهرفروشی': '💎',
  'زرگری': '💍', 'ساعت فروشی': '⌚',
  
  // آرایشگاه و زیبایی
  'آرایشگاه': '💇', 'سالن زیبایی': '💅', 'لوازم آرایشی': '💄', 'آرایشگاه مردانه': '💇‍♂️', 
  'آرایشگاه زنانه': '💇‍♀️', 'پیرایش مردانه': '✂️', 'مانیکور پدیکور': '💅', 
  'ماساژ درمانی': '💆', 'سولاریوم': '☀️', 'لیزر موهای زائد': '⚡',
  'سالن آرایش': '💇', 'آرایش و پیرایش': '💇',
  
  // دارو و پزشکی
  'داروخانه': '💊', 'عطاری': '🌿', 'طب سنتی': '🌱', 'مطب': '🏥', 'دندانپزشکی': '🦷', 
  'چشم‌پزشکی': '👁️', 'آزمایشگاه': '🔬', 'رادیولوژی': '📡', 'فیزیوتراپی': '🏋️', 
  'کلینیک': '🏥', 'درمانگاه': '⚕️', 'طب طبیعی': '🍃', 'داروخانه آنلاین': '💻',
  'عطر و ادکلن': '🌸', 'محصولات بهداشتی': '🧴', 'لوازم پزشکی': '🩺', 'اپتیک': '👓', 
  'سمعک': '👂', 'ارتوپدی': '🦴', 'بیمارستان': '🏥', 'مرکز درمانی': '⚕️',
  
  // الکترونیک و دیجیتال
  'موبایل‌فروشی': '📱', 'کامپیوتر': '💻', 'لپ‌تاپ': '💻', 'لوازم الکترونیکی': '⚡', 
  'لوازم خانگی': '🏠', 'تلویزیون': '📺', 'سیستم صوتی': '🔊', 'دوربین': '📷', 
  'گوشی همراه': '📞', 'تبلت': '📱', 'کنسول بازی': '🎮', 'بازی کامپیوتری': '🎯',
  'کافه‌نت': '🖥️', 'تعمیر کامپیوتر': '🔧', 'تعمیر موبایل': '🔧', 'شارژر و کابل': '🔌', 
  'هدفون': '🎧', 'اسپیکر': '🔊', 'ساعت هوشمند': '⌚', 'لوازم جانبی': '🔌', 
  'پرینتر': '🖨️', 'اسکنر': '📄', 'سرور': '🖥️', 'شبکه': '🌐', 'امنیت الکترونیک': '📹',
  'موبایل': '📱', 'فروشگاه موبایل': '📱', 'خدمات موبایل': '📱',
  
  // خودرو و حمل و نقل
  'تعمیرگاه خودرو': '🔧', 'نمایشگاه خودرو': '🚗', 'خودروی کارکرده': '🚙', 'پمپ بنزین': '⛽', 
  'لوازم یدکی': '🔩', 'تایر فروشی': '🛞', 'باتری خودرو': '🔋', 'روغن موتور': '🛢️', 
  'کارواش': '🚿', 'صافکاری': '🔨', 'نقاشی خودرو': '🎨', 'تعمیرات موتورسیکلت': '🏍️', 
  'فروش موتور': '🏍️', 'دوچرخه': '🚲', 'لوازم دوچرخه': '🚲', 'اتوگاز': '🚗',
  'خدمات رانندگی': '🚖', 'تاکسی تلفنی': '🚕', 'اتوبوس': '🚌', 'کامیون': '🚛', 
  'ماشین‌آلات راهسازی': '🚜', 'اتومکانیک': '🔧', 'خودرو': '🚗', 'اتو سرویس': '🚗',
  
  // بانک و مالی
  'بانک': '🏦', 'صرافی': '💱', 'بیمه': '🛡️', 'صندوق قرض‌الحسنه': '💰', 'لیزینگ': '💳', 
  'حسابداری': '📊', 'مالیاتی': '📋', 'مشاوره سرمایه‌گذاری': '📈', 'شرکت بیمه': '🛡️',
  'موسسه مالی': '🏦', 'خدمات بانکی': '🏦',
  
  // املاک و ساختمان
  'املاک': '🏡', 'مشاورین املاک': '🏘️', 'رهن و اجاره': '🏠', 'خرید و فروش': '🏪',
  'ارزیابی املاک': '📏', 'مسکن مهر': '🏗️', 'پروژه ساختمانی': '🏗️', 'پیمانکاری': '👷', 
  'معماری': '📐', 'آژانس املاک': '🏘️', 'مشاور املاک': '🏡', 'بنگاه معاملات': '🏠',
  
  // هتل و گردشگری
  'هتل': '🏨', 'مهمان‌خانه': '🏠', 'هتل آپارتمان': '🏢', 'اقامتگاه بوم‌گردی': '🏕️', 
  'ویلا': '🏡', 'کمپ': '⛺', 'آژانس مسافرتی': '✈️', 'تور مسافرتی': '🎒', 
  'بلیت هواپیما': '🎫', 'رزرواسیون': '📅', 'راهنمای تور': '🗺️', 'اجاره ماشین': '🚗', 
  'تاکسی گردشگری': '🚕', 'راهنمای گردشگری': '👨‍💼', 'کشتی تفریحی': '⛵',
  'دفتر خدمات مسافرتی': '✈️', 'خدمات گردشگری': '🗺️',
  
  // ورزش و تفریح
  'باشگاه ورزشی': '🏋️', 'زورخانه': '💪', 'استخر': '🏊', 'زمین فوتبال': '⚽', 
  'سالن بدمینتون': '🏸', 'تنیس': '🎾', 'کوهنوردی': '⛰️', 'ورزش‌های آبی': '🏄', 
  'لوازم ورزشی': '⚽', 'بازی‌های کامپیوتری': '🎮', 'تفریحگاه': '🎡', 'پارک آبی': '🏊', 
  'شهربازی': '🎠', 'سالن بولینگ': '🎳', 'بیلیارد': '🎱', 'اسکیت': '⛸️', 
  'دوچرخه‌سواری': '🚴', 'باشگاه': '🏋️', 'ورزشگاه': '⚽',
  
  // آموزش و فرهنگ
  'کتابفروشی': '📚', 'لوازم التحریر': '✏️', 'آموزشگاه': '🎓', 'مدرسه خصوصی': '🏫', 
  'کلاس خصوصی': '👨‍🏫', 'آموزش زبان': '🌍', 'کامپیوتر آموز': '💻', 'آموزش موسیقی': '🎵', 
  'آموزش رانندگی': '🚗', 'مهد کودک': '👶', 'کتابخانه': '📖', 'نشریات': '📰', 
  'مطبوعات': '📄', 'تایپ و تکثیر': '🖨️', 'طراحی گرافیک': '🎨', 'چاپخانه': '🖨️',
  'مرکز آموزشی': '🎓', 'موسسه آموزشی': '📚', 'دانشگاه': '🎓',
  
  // هنر و رسانه
  'عکاسی': '📸', 'فیلم‌برداری': '🎬', 'استودیو': '🎥', 'گالری هنری': '🖼️', 
  'صنایع دستی': '🎭', 'آنتیک': '🏺', 'آتلیه': '📷', 'استودیو عکاسی': '📸',
  
  // کشاورزی و دامپروری
  'کشاورزی': '🌾', 'باغداری': '🌳', 'گلخانه': '🏡', 'فروش بذر': '🌱', 
  'کود کشاورزی': '🌿', 'ماشین‌آلات کشاورزی': '🚜', 'دامپروری': '🐄', 'مرغداری': '🐔', 
  'زنبورداری': '🐝', 'پرورش ماهی': '🐟', 'قارچ پروری': '🍄', 'گل و گیاه': '🌺',
  'گل‌فروشی': '🌹', 'باغبانی': '🌸', 'محصولات ارگانیک': '🥬', 'کنسرو و غذاهای آماده': '🥫',
  'نهالستان': '🌱', 'سم و کود': '🌿',
  
  // صنعت و تولید
  'کارخانه': '🏭', 'صنایع غذایی': '🏭', 'صنایع نساجی': '🧵', 'فلزکاری': '🔨', 
  'جوشکاری': '⚡', 'نجاری': '🪚', 'کابینت‌سازی': '🪑', 'صنایع چوب': '🌲', 
  'پلاستیک‌سازی': '♻️', 'شیشه‌سازی': '🪟', 'سرامیک': '🏺', 'موزاییک': '🎨',
  'رنگ‌سازی': '🎨', 'محصولات شیمیایی': '🧪', 'دارو‌سازی': '💊', 'کارگاه مونتاژ': '🔧', 
  'تعمیرگاه صنعتی': '⚙️', 'صنعتگر': '🔧', 'تولیدی': '🏭', 'کارگاه': '🔧',
  
  // هدایا و مراسم
  'اسباب‌بازی': '🧸', 'هدایا و سوغات': '🎁', 'پارتی و جشن': '🎉', 'تولد و مراسم': '🎂', 
  'عکس‌فوری': '📸', 'تشریفات': '🎊', 'لوازم جشن': '🎈',
  
  // خدمات عمومی
  'خدمات نظافت': '🧹', 'خدمات باغبانی': '🌿', 'نگهبانی': '👮', 'حمل و نقل': '🚚', 
  'بسته‌بندی': '📦', 'بار': '📦', 'انبار': '🏪', 'حمل اثاثیه': '🚛', 'آسانسور': '🛗', 
  'تاسیسات': '🔧', 'برق‌کاری': '⚡', 'آب و فاضلاب': '💧', 'گاز': '🔥', 
  'بازیافت': '♻️', 'مواد بازیافتی': '♻️', 'ضایعات': '🗑️', 'زباله': '🗑️', 
  'محیط زیست': '🌍', 'خدمات عمومی': '🏪', 'دفتر خدمات': '🏢',
  
  // حقوقی و مشاوره
  'وکالت': '📋', 'دفتر وکالت': '⚖️', 'مشاوره حقوقی': '📜', 'دفتر اسناد رسمی': '📝',
  'ثبت شرکت': '📋', 'خدمات حقوقی': '⚖️',
...
export function getBusinessIcon(businessType: string): string {
  ...
  if (businessIconsMap[businessType]) {
    return businessIconsMap[businessType];
  }
  
  // Normalize the business type for better matching
  const normalizedType = businessType.trim().toLowerCase();
  
  // Try to find a partial match - check if any key is contained in the business type
  for (const [key, icon] of Object.entries(businessIconsMap)) {
    const normalizedKey = key.toLowerCase();
    // Check if the business type contains the key or vice versa
    if (normalizedType.includes(normalizedKey) || normalizedKey.includes(normalizedType)) {
      return icon;
    }
  }
  
  // Enhanced keyword matching for common Persian business categories from Excel column AN
  // Ordered by specificity (more specific keywords first)
  const keywordMatches: [string, string][] = [
    // غذا و رستوران
    ['سوپرمارکت', '🛒'], ['خواربار', '🛒'], ['خوراک', '🍽️'],
    ['رستوران', '🍽️'], ['اغذیه', '🍔'], ['کباب', '🥙'], ['چلو', '🍛'], 
    ['پیتزا', '🍕'], ['ساندویچ', '🥪'], ['فست فود', '🍟'], ['فست‌فود', '🍟'],
    ['کافه', '☕'], ['قهوه', '☕'], ['چای', '🍵'], ['نوشیدنی', '🥤'],
    ['نان', '🍞'], ['شیرینی', '🧁'], ['قنادی', '🎂'], ['کیک', '🎂'],
    ['بستنی', '🍦'], ['آبمیوه', '🥤'],
    ['میوه', '🍎'], ['سبزی', '🥬'], ['تره بار', '🥕'], ['گوشت', '🥩'], 
    ['مرغ', '🐔'], ['ماهی', '🐟'], ['لبنیات', '🥛'], ['آجیل', '🥜'], ['خشکبار', '🥜'],
    ['سوپر', '🛒'], ['مارکت', '🛒'], ['فروشگاه', '🏪'], ['بقالی', '🏪'], ['مواد غذایی', '🛒'],
    
    // پوشاک
    ['پوشاک', '👕'], ['لباس', '👕'], ['البسه', '👕'], ['بوتیک', '👗'], ['مزون', '👗'],
    ['کیف', '👜'], ['کفش', '👟'], ['چرم', '🧥'], ['پارچه', '🧵'], ['خیاط', '🧷'], ['منسوجات', '🧵'],
    
    // طلا و جواهر
    ['طلا', '💍'], ['جواهر', '💎'], ['زرگر', '💍'], ['نقره', '⚪'], ['ساعت', '⌚'],
    
    // آرایش و زیبایی
    ['آرایش', '💇'], ['زیبایی', '💅'], ['پیرایش', '✂️'], ['سالن', '💇'],
    
    // دارو و پزشکی
    ['دارو', '💊'], ['عطاری', '🌿'], ['پزشک', '🏥'], ['دندان', '🦷'], ['چشم', '👁️'], 
    ['کلینیک', '🏥'], ['درمان', '⚕️'], ['بیمارستان', '🏥'], ['آزمایشگاه', '🔬'],
    ['عطر', '🌸'], ['ادکلن', '🌸'], ['بهداشت', '🧴'], ['اپتیک', '👓'], ['عینک', '👓'],
    
    // الکترونیک
    ['موبایل', '📱'], ['گوشی', '📱'], ['کامپیوتر', '💻'], ['لپ تاپ', '💻'], ['لپ‌تاپ', '💻'],
    ['الکترون', '⚡'], ['تلویزیون', '📺'], ['دوربین', '📷'], ['صوتی', '🔊'],
    ['لوازم خانگی', '🏠'], ['برقی', '⚡'],
    
    // خودرو
    ['خودرو', '🚗'], ['ماشین', '🚗'], ['اتومبیل', '🚗'], ['موتور', '🏍️'],
    ['تعمیر', '🔧'], ['یدکی', '🔩'], ['تایر', '🛞'], ['لاستیک', '🛞'],
    ['کارواش', '🚿'], ['بنزین', '⛽'], ['پمپ', '⛽'], ['مکانیک', '🔧'],
    
    // بانک و مالی
    ['بانک', '🏦'], ['صرافی', '💱'], ['بیمه', '🛡️'], ['حساب', '📊'], ['مالی', '📊'],
    ['صندوق', '💰'], ['لیزینگ', '💳'],
    
    // املاک و ساختمان
    ['املاک', '🏡'], ['مسکن', '🏠'], ['ساختمان', '🏗️'], ['معمار', '📐'], 
    ['پیمانکار', '👷'], ['مصالح', '🧱'], ['آهن آلات', '🔩'],
    
    // هتل و گردشگری
    ['هتل', '🏨'], ['مسافر', '✈️'], ['تور', '🎒'], ['گردشگری', '🗺️'], ['آژانس', '✈️'],
    
    // ورزش
    ['ورزش', '🏋️'], ['باشگاه', '🏋️'], ['استخر', '🏊'], ['فوتبال', '⚽'], ['بدنسازی', '💪'],
    
    // آموزش
    ['کتاب', '📚'], ['تحریر', '✏️'], ['آموزش', '🎓'], ['مدرسه', '🏫'], ['زبان', '🌍'],
    ['دانشگاه', '🎓'], ['موسسه', '🏢'],
    
    // هنر و چاپ
    ['چاپ', '🖨️'], ['طراحی', '🎨'], ['عکاس', '📸'], ['فیلم', '🎬'], ['استودیو', '🎥'],
    ['گالری', '🖼️'], ['صنایع دستی', '🎭'],
    
    // کشاورزی
    ['کشاورز', '🌾'], ['باغ', '🌳'], ['گل', '🌹'], ['گیاه', '🌱'], ['نهال', '🌱'],
    ['دام', '🐄'], ['مرغداری', '🐔'], ['ماکیان', '🐔'],
    
    // صنعت
    ['کارخانه', '🏭'], ['صنعت', '🏭'], ['تولید', '🏭'], ['کارگاه', '🔧'],
    ['نساجی', '🧵'], ['فلز', '🔨'], ['نجار', '🪚'], ['چوب', '🌲'], ['جوش', '⚡'],
    
    // هدایا
    ['اسباب بازی', '🧸'], ['اسباب‌بازی', '🧸'], ['هدیه', '🎁'], ['سوغات', '🎁'], ['جشن', '🎉'],
    
    // خدمات
    ['نظافت', '🧹'], ['حمل', '🚚'], ['باربری', '🚛'], ['انبار', '🏪'],
    ['برق', '⚡'], ['تاسیسات', '🔧'], ['لوله', '💧'], ['گاز', '🔥'],
    ['حقوق', '📋'], ['وکیل', '⚖️'], ['مشاور', '👨‍💼'], ['خدمات', '🏪'],
